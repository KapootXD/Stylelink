        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Get help with StyleLink and find answers to your questions.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="bg-white rounded-2xl p-12 shadow-lg">
              ...
              <p className="text-xl text-[#2D2D2D]/70 mb-8 leading-relaxed">
                We're building a comprehensive support center with FAQs, guides, and direct help options. 
                Soon you'll have access to detailed documentation and personalized assistance.
              </p>
