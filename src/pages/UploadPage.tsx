    ...
    <div className="min-h-screen bg-[#FAF3E0]">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Share your style with the StyleLink community and inspire others.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <ProtectedFeature feature="upload">
            <motion.div
              initial="initial"
              animate="animate"
              variants={fadeInUp}
            >
              <div className="bg-white rounded-2xl p-12 shadow-lg text-center">
                ...
                <p className="text-xl text-[#2D2D2D]/70 mb-8 leading-relaxed">
                  We're building an amazing upload experience where you can share your outfits, 
                  tag products, and connect with the StyleLink community. Stay tuned for this exciting feature!
                </p>
