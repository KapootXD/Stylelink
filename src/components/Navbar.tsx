        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-secondary-200">
            ...
            <button
              ...
              className="flex items-center px-3 py-2 rounded-md text-base font-medium transition-colors text-secondary-700 hover:text-primary-600 hover:bg-secondary-50 w-full text-left"
            >
